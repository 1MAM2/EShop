      ...
      {isHaveAnAccount ? (
            ...
            <form action="" method="post" className="" onSubmit={handleSubmit}>
              <div className="flex justify-center items-center flex-col">
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <button onClick={()=>setIsHaveAnAccount(false)} className="w-36 p-2 my-4 bg-cyan-500 rounded-xl hover:bg-cyan-600 active:bg-cyan-700 transition">Register</button>
                </div>
              </div>
            </form>
          </div>
        ...
        <div>
          <div className="register bg-blue-900 m-4 p-4 rounded-4xl max-w-sm w-full text-white">
            ...
            <form action="" method="post" className="" onSubmit={handleRegister}>
              <div className="flex justify-center items-center flex-col">
                <div className="my-4">
                  <label
                    htmlFor="userName"
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <button onClick={()=>setIsHaveAnAccount(true)} className="w-36 p-2 my-4 bg-cyan-500 rounded-xl hover:bg-cyan-600 active:bg-cyan-700 transition">Login</button>
                </div>
              </div>
            </form>
          </div>
